...
export const AdminDetails: React.FC<AdminDetailsProps> = ({ adminInfo, onUpdateAdmin }) => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-[600px] mx-auto animate-fade-in">
      {showSuccess && (
